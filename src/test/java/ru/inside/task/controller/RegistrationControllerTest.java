...
public class RegistrationControllerTest {
    ...
    public void correctRegistrationTest() throws Exception {
        UserDtoRequest userDto = new UserDtoRequest(USER_1.getUsername(), USER_1.getPassword(), null);
        mockMvc.perform(post("/api/v1/registration")
                ...
                .andExpect(jsonPath("$.name").value(USER_1.getUsername()))
                .andExpect(jsonPath("$.roles[0].name").value("ROLE_USER"));
    }

    @Test
    public void badPasswordRegistration() throws Exception {
        UserDtoRequest userDto = new UserDtoRequest(USER_1.getUsername(), null, null);
        mockMvc.perform(post("/api/v1/registration")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .content(objectToJson(userDto)))
    ...
    @Test
    public void badNameRegistration() throws Exception {
        UserDtoRequest userDto = new UserDtoRequest(null, USER_1.getPassword(), null);
        mockMvc.perform(post("/api/v1/registration")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .content(objectToJson(userDto)))
